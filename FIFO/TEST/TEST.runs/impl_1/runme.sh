...
HD_PWD='C:/Users/meteh/OneDrive/Belgeler/Verilog_projects/FIFO/TEST/TEST.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_FIFO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_module_FIFO.tcl -notrace
