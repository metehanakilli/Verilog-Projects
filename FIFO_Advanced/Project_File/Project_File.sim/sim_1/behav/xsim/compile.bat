...
REM
REM Generated by Vivado on Thu Jul 16 21:25:27 +0300 2026
...
echo "xvlog --incr --relax -prj top_module_FIFO_TB_vlog.prj"
call xvlog  --incr --relax -prj top_module_FIFO_TB_vlog.prj -log xvlog.log
